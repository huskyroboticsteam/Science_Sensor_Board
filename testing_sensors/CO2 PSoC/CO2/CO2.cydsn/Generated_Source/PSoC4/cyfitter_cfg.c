...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x00400806u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x0040000Eu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDB_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL5), 0x00007699u);
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT3_TR_CTRL0), 0x000AAA10u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x0000005Eu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00186001u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT4_BASE), 0x00000007u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT5_BASE), 0x0000000Eu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC), 0x00000031u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC2), 0x0000000Eu);
