...
module CapSense_CSD_P4_v2_60_4 ;
	...
	cy_clock_v1_0
		#(.id("953e8675-31b7-4bc9-a96a-4d6f5d6ced57/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("953e8675-31b7-4bc9-a96a-4d6f5d6ced57/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("953e8675-31b7-4bc9-a96a-4d6f5d6ced57/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
	...
	cy_clock_v1_0
		#(.id("953e8675-31b7-4bc9-a96a-4d6f5d6ced57/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
// IDAC_P4_v1_10(IDACRange=1, IDACValue=120, Polarity=0, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDAC_8bit, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_8bit, CY_INSTANCE_SHORT_NAME=IDAC_8bit, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=IDAC_8bit, )
...
// IDAC_P4_v1_10(IDACRange=1, IDACValue=120, Polarity=1, Resolution=7, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDAC_7bit, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_7bit, CY_INSTANCE_SHORT_NAME=IDAC_7bit, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=IDAC_7bit, )
module IDAC_P4_v1_10_6 (
    Iout);
    inout       Iout;
    electrical  Iout;
...
module ADC_SAR_SEQ_P4_v2_60_9 (
    ...
    defparam cy_psoc4_sarmux_8.input_mode = "0100";
...
module top ;
	...
	wire [0:0] tmpOE__IDAC_8bit_Out_net;
	wire [0:0] tmpFB_0__IDAC_8bit_Out_net;
	wire [0:0] tmpIO_0__IDAC_8bit_Out_net;
	wire [0:0] tmpINTERRUPT_0__IDAC_8bit_Out_net;
	electrical [0:0] tmpSIOVREF__IDAC_8bit_Out_net;

	cy_psoc3_pins_v1_10
		#(.id("cc0744b4-2fab-4822-b514-1068f4444fcb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IDAC_8bit_Out
		 (.oe(tmpOE__IDAC_8bit_Out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IDAC_8bit_Out_net[0:0]}),
		  .analog({Net_1037}),
		  .io({tmpIO_0__IDAC_8bit_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__IDAC_8bit_Out_net),
		  .interrupt({tmpINTERRUPT_0__IDAC_8bit_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IDAC_8bit_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IDAC_7bit_In_net;
	wire [0:0] tmpFB_0__IDAC_7bit_In_net;
	wire [0:0] tmpIO_0__IDAC_7bit_In_net;
	wire [0:0] tmpINTERRUPT_0__IDAC_7bit_In_net;
	electrical [0:0] tmpSIOVREF__IDAC_7bit_In_net;

	cy_psoc3_pins_v1_10
		#(.id("8420d63a-23b7-420a-9582-e34547fc5b99"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IDAC_7bit_In
		 (.oe(tmpOE__IDAC_7bit_In_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IDAC_7bit_In_net[0:0]}),
		  .analog({Net_1038}),
		  .io({tmpIO_0__IDAC_7bit_In_net[0:0]}),
		  .siovref(tmpSIOVREF__IDAC_7bit_In_net),
		  .interrupt({tmpINTERRUPT_0__IDAC_7bit_In_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IDAC_7bit_In_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    IDAC_P4_v1_10_5 IDAC_8bit (
        .Iout(Net_1037));

    IDAC_P4_v1_10_6 IDAC_7bit (
        .Iout(Net_1038));
    ...
    OpAmp_P4_v1_20_7 ADC_2_Buffer (
        .Vminus(Net_1040),
        .Vout(Net_251),
        .Vplus(Net_689));

    OpAmp_P4_v1_20_8 ADC_3_Buffer (
        .Vminus(Net_1041),
        .Vout(Net_252),
        .Vplus(Net_682));
	...
	cy_psoc3_pins_v1_10
		#(.id("8123c388-f55b-4120-b6ac-cdc49972457f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cfcb9508-c610-45a3-9dee-8784b940ef4f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
