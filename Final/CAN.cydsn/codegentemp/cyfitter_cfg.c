...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL6, 0x00002700u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_CMD, 0x8000FF46u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL7, 0x00002700u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_CMD, 0x8000FF47u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL1, 0x0000FE00u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_CMD, 0x8000FF41u);
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL2, 0x0000FE00u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL3, 0x00000100u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL14), 0x00000046u);

	/* CYDEV_PERI_PCLK_CTL13 Starting address: CYDEV_PERI_PCLK_CTL13 */
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL13), 0x00000046u);
	...
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL11), 0x00000046u);

	/* CYDEV_PERI_PCLK_CTL10 Starting address: CYDEV_PERI_PCLK_CTL10 */
	CY_SET_REG32((void *)(CYREG_PERI_PCLK_CTL10), 0x00000047u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x00408050u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x004000D0u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDB_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F4403u, /* Base address: 0x400F4400 Count: 3 */
			0x400F4507u, /* Base address: 0x400F4500 Count: 7 */
			0x400F4607u, /* Base address: 0x400F4600 Count: 7 */
			0x400F4705u, /* Base address: 0x400F4700 Count: 5 */
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0xF8000000u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00000800u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL2), 0x00000FFFu);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x0008EE08u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL4), 0x0AA00099u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL5), 0x000076EEu);

		/* UDB_PA_0 Starting address: CYDEV_UDB_PA0_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA0_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x00050000u);
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x00099910u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00240000u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x000000D2u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00000271u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_INTR_CFG), 0x00000080u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC2), 0x000000D2u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x00000013u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00006D96u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT5_BASE), 0x0000000Fu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC), 0x00000024u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC2), 0x0000000Cu);
