...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL7, 0x00002F00u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL5, 0x00002200u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x00400221u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x00400023u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDB_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT3_TR_CTRL0), 0x00099910u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00006C48u);
