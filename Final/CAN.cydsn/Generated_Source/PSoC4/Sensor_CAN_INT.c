...
*
*******************************************************************************/
CY_ISR(Sensor_CAN_ISR)
{
    #ifdef Sensor_CAN_ISR_INTERRUPT_CALLBACK
        Sensor_CAN_ISR_InterruptCallback();
    #endif /* Sensor_CAN_ISR_INTERRUPT_CALLBACK */
